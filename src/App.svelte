  ...
  const projects = [
    {
      ...
      description:
        "A completely local clone of lovable.dev that builds a deployment-ready NextJS application with solely text prompts and using any AI models of your choosing (including your local Ollama cluster). No coding knowledge required. Currently works off LangGraph + FastAPI local server and a Tauri app client, but a Rust rewrite is ongoing to improve UX and reliability by entirely handling project logic and LLM calls via Tauri invokes.",
    },
    {
      title: "Dreamberd (WIP)",
...
>
  <div class="flex flex-col gap-4 md:gap-6 w-full">
    <div class="max-w-4xl m-auto w-full">
      ...
      <p
        class="text-xl sm:text-2xl md:text-3xl lg:text-4xl text-gvb-white font-huge pl-2 md:pl-4 m-auto text-center mt-1"
      >
